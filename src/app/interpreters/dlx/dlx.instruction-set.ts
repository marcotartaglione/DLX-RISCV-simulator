import {DLXDataSizeName, DLXImmediateValueSize, InstructionConfig} from './dlx.types';
import {DLXInstruction, specialRegisters} from './dlx.instructions';
...
export const instructions: {
  ...
  SGT: {
    type: 'Register',
    func: (registers) => instructions['SGTI'].func(registers)
  },
  SGTI: {
    type: 'Immediate',
    func: (registers) => registers.c = registers.a > registers.temp ? 1 : 0
  ...
  SLT: {
    type: 'Register',
    func: (registers) => instructions['SLTI'].func(registers)
  },
  SLTI: {
    type: 'Immediate',
    func: (registers) => registers.c = registers.a < registers.temp ? 1 : 0
 ...
 */
function loadValue(value: number, offset: number, dim: DLXDataSizeName) {
